...
sed -i "s/<REPLACE_DOMAIN>/$domain/g" {authentification/authelia/docker-compose.yml,authentification/authelia/config/configuration.yml,authentification/authelia/config/users_database.yml,authentification/traefik/docker-compose.yml,modules/flag-in-container/docker-compose.yml,modules/getting-at-the-door/docker-compose.yml}
